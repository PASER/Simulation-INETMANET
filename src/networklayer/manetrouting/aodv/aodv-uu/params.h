...
#define TTL_START_HELLO             (int)par("ttl_start")
//end edit
...
#define HELLO_INTERVAL          (int)par("hello_interval")
//end edit
...
#define NET_DIAMETER            (int)par("net_diameter")
#define NET_TRAVERSAL_TIME      (int)par("rreq_wait_timeout")
//end edit
